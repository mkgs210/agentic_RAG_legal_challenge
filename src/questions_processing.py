...
class QuestionsProcessor:
    def __init__(
        ...
        if self.llm_reranking or self.use_bm25_db:
            self.retriever = HybridRetriever(
                ...
                bm25_auto=self.bm25_auto,
                enable_reranking=self.llm_reranking,
    ...
    def get_answer_for_company(self, company_name: str, question: str, schema: str) -> dict:
        if self.full_context:
            retrieval_results = self.vector_retriever.retrieve_all(company_name)
        else:           
