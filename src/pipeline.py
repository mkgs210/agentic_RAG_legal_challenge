...
class RunConfig:
    ...
    reranker_model: str = "gpt-4o-mini-2024-07-18"
...
# I wanted to download them prior to running the pipeline and created this crutch
    ...
    def process_questions(self):
        processor = QuestionsProcessor(
            ...
            bm25_auto=self.run_config.bm25_auto,
            ...
            embedding_provider=self.run_config.embedding_provider,
            embedding_model=self.run_config.embedding_model,
            reranker_provider=self.run_config.reranker_provider,
            reranker_model=self.run_config.reranker_model,
        )
...
preprocess_configs = {
    ...
    "local_ser_tab": RunConfig(
        use_serialized_tables=True,
        embedding_provider="local",
        embedding_model=DEFAULT_LOCAL_EMBEDDING_MODEL,
    ),
    "local_no_ser_tab": RunConfig(
        use_serialized_tables=False,
        embedding_provider="local",
        embedding_model=DEFAULT_LOCAL_EMBEDDING_MODEL,
    ),
    "local_no_ser_tab_bm25": RunConfig(
        use_serialized_tables=False,
        use_bm25_db=True,
        embedding_provider="local",
        embedding_model=DEFAULT_LOCAL_EMBEDDING_MODEL,
    ),
    "local_no_ser_tab_bm25_auto": RunConfig(
        use_serialized_tables=False,
        use_bm25_db=True,
        bm25_auto=True,
        embedding_provider="local",
...
gemini_free_config = RunConfig(
    ...
    top_n_retrieval=10,
    submission_name="Gemini Free + Local Retrieval",
    pipeline_details="Local multilingual-e5 embeddings + local jina reranker + Gemini free tier answering",
    api_provider="gemini",
    embedding_provider="local",
    embedding_model=DEFAULT_LOCAL_EMBEDDING_MODEL,
    reranker_provider="local_jina",
    reranker_model=DEFAULT_LOCAL_RERANKER_MODEL,
    answering_model=os.getenv("GEMINI_MODEL", "gemini-2.5-flash"),
    config_suffix="_gemini_free"
)

openrouter_free_config = RunConfig(
    use_serialized_tables=False,
    parent_document_retrieval=True,
    llm_reranking=True,
    parallel_requests=1,
    llm_reranking_sample_size=24,
    top_n_retrieval=10,
    submission_name="OpenRouter Free + Local Retrieval",
    pipeline_details="Local multilingual-e5 embeddings + local jina reranker + OpenRouter free answering",
    api_provider="openrouter",
    embedding_provider="local",
    embedding_model=DEFAULT_LOCAL_EMBEDDING_MODEL,
    reranker_provider="local_jina",
    reranker_model=DEFAULT_LOCAL_RERANKER_MODEL,
    answering_model=os.getenv("OPENROUTER_MODEL", "qwen/qwen3-235b-a22b:free"),
    config_suffix="_openrouter_free"
)

sambanova_free_config = RunConfig(
    use_serialized_tables=False,
    parent_document_retrieval=True,
    llm_reranking=True,
    parallel_requests=1,
    llm_reranking_sample_size=24,
    top_n_retrieval=10,
    submission_name="SambaNova Free + Local Retrieval",
    pipeline_details="Local multilingual-e5 embeddings + local jina reranker + SambaNova free answering",
    api_provider="sambanova",
    embedding_provider="local",
    embedding_model=DEFAULT_LOCAL_EMBEDDING_MODEL,
    reranker_provider="local_jina",
    reranker_model=DEFAULT_LOCAL_RERANKER_MODEL,
    answering_model=os.getenv("SAMBANOVA_MODEL", "Qwen3-32B"),
    config_suffix="_sambanova_free"
)

groq_free_config = RunConfig(
    use_serialized_tables=False,
    parent_document_retrieval=True,
    llm_reranking=True,
    parallel_requests=1,
    llm_reranking_sample_size=24,
    top_n_retrieval=10,
    submission_name="Groq Free + Local Retrieval",
    pipeline_details="Local multilingual-e5 embeddings + local jina reranker + Groq free answering",
    api_provider="groq",
    embedding_provider="local",
    embedding_model=DEFAULT_LOCAL_EMBEDDING_MODEL,
    reranker_provider="local_jina",
    reranker_model=DEFAULT_LOCAL_RERANKER_MODEL,
    answering_model=os.getenv("GROQ_MODEL", "qwen/qwen3-32b"),
    config_suffix="_groq_free"
)

mistral_free_config = RunConfig(
    use_serialized_tables=False,
    parent_document_retrieval=True,
    llm_reranking=True,
    parallel_requests=1,
    llm_reranking_sample_size=24,
    top_n_retrieval=10,
    submission_name="Mistral Free + Local Retrieval",
    pipeline_details="Local multilingual-e5 embeddings + local jina reranker + Mistral free answering",
    api_provider="mistral",
    embedding_provider="local",
    embedding_model=DEFAULT_LOCAL_EMBEDDING_MODEL,
    reranker_provider="local_jina",
    reranker_model=DEFAULT_LOCAL_RERANKER_MODEL,
    answering_model=os.getenv("MISTRAL_MODEL", "mistral-small-latest"),
    config_suffix="_mistral_free"
)

cerebras_free_config = RunConfig(
    use_serialized_tables=False,
    parent_document_retrieval=True,
    llm_reranking=True,
    parallel_requests=1,
    llm_reranking_sample_size=24,
    top_n_retrieval=10,
    submission_name="Cerebras Free + Local Retrieval",
    pipeline_details="Local multilingual-e5 embeddings + local jina reranker + Cerebras free answering",
    api_provider="cerebras",
    embedding_provider="local",
    embedding_model=DEFAULT_LOCAL_EMBEDDING_MODEL,
    reranker_provider="local_jina",
    reranker_model=DEFAULT_LOCAL_RERANKER_MODEL,
    answering_model=os.getenv("CEREBRAS_MODEL", "qwen-3-32b"),
    config_suffix="_cerebras_free"
)

cohere_free_config = RunConfig(
    use_serialized_tables=False,
    parent_document_retrieval=True,
    llm_reranking=True,
    parallel_requests=1,
    llm_reranking_sample_size=24,
    top_n_retrieval=10,
    submission_name="Cohere Trial + Local Retrieval",
    pipeline_details="Local multilingual-e5 embeddings + local jina reranker + Cohere trial answering",
    api_provider="cohere",
    embedding_provider="local",
    embedding_model=DEFAULT_LOCAL_EMBEDDING_MODEL,
    reranker_provider="local_jina",
    reranker_model=DEFAULT_LOCAL_RERANKER_MODEL,
    answering_model=os.getenv("COHERE_MODEL", "command-a-03-2025"),
    config_suffix="_cohere_free"
)

local_free_config = RunConfig(
    use_serialized_tables=False,
    parent_document_retrieval=True,
    llm_reranking=True,
    parallel_requests=1,
    llm_reranking_sample_size=24,
    top_n_retrieval=10,
    submission_name="Local Qwen + Jina",
    pipeline_details="Local multilingual-e5 embeddings + local jina-reranker-v2-base-multilingual + local Qwen reasoning",
    api_provider="local",
    embedding_provider="local",
    embedding_model=DEFAULT_LOCAL_EMBEDDING_MODEL,
    reranker_provider="local_jina",
    reranker_model=DEFAULT_LOCAL_RERANKER_MODEL,
    answering_model=DEFAULT_LOCAL_LLM_MODEL,
    config_suffix="_local_free"
)

local_free_bm25_config = RunConfig(
    use_serialized_tables=False,
    parent_document_retrieval=True,
    use_bm25_db=True,
    llm_reranking=True,
    ...
    llm_reranking_sample_size=24,
    top_n_retrieval=10,
    submission_name="Local Qwen + Jina + BM25",
    pipeline_details="Local multilingual-e5 embeddings + BM25 fusion + local jina-reranker-v2-base-multilingual + local Qwen reasoning",
    api_provider="local",
    embedding_provider="local",
    embedding_model=DEFAULT_LOCAL_EMBEDDING_MODEL,
    reranker_provider="local_jina",
    reranker_model=DEFAULT_LOCAL_RERANKER_MODEL,
    answering_model=DEFAULT_LOCAL_LLM_MODEL,
    config_suffix="_local_free_bm25"
)

local_free_bm25_auto_config = RunConfig(
    use_serialized_tables=False,
    parent_document_retrieval=True,
    use_bm25_db=True,
    bm25_auto=True,
    ...
    llm_reranking_sample_size=24,
    top_n_retrieval=10,
    submission_name="Local Qwen + Jina + Auto BM25",
    pipeline_details="Local multilingual-e5 embeddings + selective BM25 fusion + local jina-reranker-v2-base-multilingual + local Qwen reasoning",
    api_provider="local",
    embedding_provider="local",
    embedding_model=DEFAULT_LOCAL_EMBEDDING_MODEL,
    reranker_provider="local_jina",
    reranker_model=DEFAULT_LOCAL_RERANKER_MODEL,
    answering_model=DEFAULT_LOCAL_LLM_MODEL,
    config_suffix="_local_free_bm25_auto"
)
...
configs = {"base": base_config,
           ...
           "gemini_free": gemini_free_config,
           "openrouter_free": openrouter_free_config,
           "sambanova_free": sambanova_free_config,
           "groq_free": groq_free_config,
           "mistral_free": mistral_free_config,
           "cerebras_free": cerebras_free_config,
           "cohere_free": cohere_free_config,
           "local_free": local_free_config,
           "local_free_bm25": local_free_bm25_config,
           "local_free_bm25_auto": local_free_bm25_auto_config}
